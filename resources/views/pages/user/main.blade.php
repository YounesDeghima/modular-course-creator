...
@section('main')
    <div class="blocks-container">
        <div class="blocks">
            <div class="block">
                <div class="block-top">
                    <form action="{{route('user.preview.courses','1')}}" method="get">
                        <h3>year1</h3>
            ...
            <div class="block">
                <div class="block-top">
                    <form action="{{route('user.preview.courses','2')}}" method="get">
                        <h3>year2</h3>
                        <div class="info-row">
            ...
            <div class="block">
                <div class="block-top">
                    <form action="{{route('user.preview.courses','3')}}" method="get">
                        <h3>year3</h3>
                        <div class="info-row">
                            <label for="branch" class="branch-label">branch</label>
                            <select name="branch" class="value-input">
